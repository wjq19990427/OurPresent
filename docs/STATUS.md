...
**最后更新**：2026-05-15  ·  **当前版本**：**v3.0.0**（Unreleased 含 A2~A4 / B3~B6 技术债清理 + UI 一致性收尾）  ·  **阶段**：Phase 1 · Alpha 本地 Demo · 战略转向商业化 + E2EE（详见 `docs/DIRECTION.md` / `docs/ROADMAP.md`）
...
1. **Phase 1 W2 完成**（task-25 已合）。**W3 待开**：三视图信息架构 + 新手引导，跨三个 tab。等用户 dogfood W2 反馈后开 W3
