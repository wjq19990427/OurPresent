...
**最后更新**：2026-05-16  ·  **当前版本**：**v3.1.0**（已发布）  ·  **阶段**：Phase 2 · 准备上云（详见 `docs/DIRECTION.md` / `docs/ROADMAP.md`）
...
1. **v3.1.0 已发布，正式进入 Phase 2**。下一步：ICP 备案跟进 · 小程序 AppID（接口测试号先用） · 云端部署（服务器已租）
