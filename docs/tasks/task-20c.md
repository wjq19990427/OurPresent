...
- `docs/guide/synth-user-guide.md` 同步更新涉及 persona / 产物份数 / outcome 的章节
...
- [ ] `tools/synth/README.md` 与 `docs/guide/synth-user-guide.md` 反映新语义
...
- `docs/guide/synth-user-guide.md`
